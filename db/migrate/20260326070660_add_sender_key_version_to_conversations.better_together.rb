...
# This migration comes from better_together (originally 20260316120000)
...
class AddSenderKeyVersionToConversations < ActiveRecord::Migration[7.2]
  def change
    add_column :better_together_conversations, :sender_key_version, :integer,
               default: 0, null: false unless column_exists?(:better_together_conversations, :sender_key_version)
  end
end
