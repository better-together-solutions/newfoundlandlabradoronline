...
# This migration comes from better_together (originally 20260312223000)
class AddFederationProvenanceToBetterTogetherEvents < ActiveRecord::Migration[7.2]
  def change
    ...
    unless index_name_exists?(:better_together_events, 'index_bt_events_on_platform_and_source_id')
