...
Rails.application.configure do # rubocop:todo Metrics/BlockLength
  ...
  # config.active_job.queue_name_prefix = "newfoundland_labrador_online_production"
  ...
  config.session_store :cookie_store, key: '_newfoundland_labrador_online_session', secure: Rails.env.production?
